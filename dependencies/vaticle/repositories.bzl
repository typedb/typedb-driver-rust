...
def vaticle_typeql():
    git_repository(
        ...
        commit = "f6e0b84d3bd5370c0e5db4ba186a182d7e8e78b8", # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_dependencies
    )
